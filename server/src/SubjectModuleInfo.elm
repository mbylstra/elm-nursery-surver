...
filterByFunctionName : String -> ModuleInfo -> ModuleInfo
filterByFunctionName functionName moduleInfo =
    { moduleInfo
        | viewFunctions =
            moduleInfo.viewFunctions |> Dict.filter (\key _ -> key == functionName)
    }
