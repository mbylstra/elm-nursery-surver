...
var _user$project$Main$init = function (_p27) {
	...
	if (_p29.ctor === 'Ok') {
		var subjectModuleInfo = A2(
			_user$project$SubjectModuleInfo$filterByFunctionName,
			_p28.functionName,
			_user$project$SubjectModuleInfo$getModuleInfo(_p30));
...
var _user$project$Main$Flags = F4(
	function (a, b, c, d) {
		return {elmPackageContents: a, subjectSourceCode: b, functionName: c, exactDependenciesContents: d};
	});
						...
						function (functionName) {
							return A2(
								...
								function (subjectSourceCode) {
									return _elm_lang$core$Json_Decode$succeed(
										{elmPackageContents: elmPackageContents, exactDependenciesContents: exactDependenciesContents, functionName: functionName, subjectSourceCode: subjectSourceCode});
								},
								A2(_elm_lang$core$Json_Decode$field, 'subjectSourceCode', _elm_lang$core$Json_Decode$string));
						},
						A2(_elm_lang$core$Json_Decode$field, 'functionName', _elm_lang$core$Json_Decode$string));
				},
