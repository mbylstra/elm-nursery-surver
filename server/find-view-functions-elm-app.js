...
var _user$project$SubjectModuleInfo$filterByFunctionName = F2(
	function (functionName, moduleInfo) {
		return _elm_lang$core$Native_Utils.update(
			moduleInfo,
			{
				viewFunctions: A2(
					...
					F2(
						function (key, _p1) {
							return _elm_lang$core$Native_Utils.eq(key, functionName);
						}),
					moduleInfo.viewFunctions)
			});
	});
var _user$project$SubjectModuleInfo$getViewFunctions = function (blocks) {
	return _elm_lang$core$Dict$fromList(
		A2(
			...
			function (block) {
				var _p2 = block;
				if ((_p2.ctor === 'TypeAnnotation') && (_p2._0.ctor === '_Tuple2')) {
					var _p3 = _p2._0._1;
					return _user$project$ViewFunctionDetector$isViewFunction(_p3) ? _elm_lang$core$Maybe$Just(
						{ctor: '_Tuple2', _0: _p2._0._0, _1: _p3}) : _elm_lang$core$Maybe$Nothing;
				} else {
					return _elm_lang$core$Maybe$Nothing;
				}
			},
...
var _user$project$SubjectModuleInfo$getExternalNames = function (_p4) {
	var _p5 = _p4;
	var viewFunctionNames = A2(
		_elm_lang$core$List$filter,
		function (_p6) {
			return !_user$project$ModuleInfo$isCoreName(_p6);
		},
		_user$project$Helpers$removeDuplicates(
			A2(
				_elm_lang$core$List$concatMap,
				_user$project$SubjectModuleInfo$getNames,
				_elm_lang$core$Dict$values(_p5.viewFunctions))));
	return A2(
		_user$project$ModuleInfo$getExternalNames,
		A2(_user$project$ModuleInfo$LocalTypeDefinitions, _p5.localUnionTypes, _p5.localTypeAliases),
		viewFunctionNames);
};
...
var _user$project$FindViewFunctionsApp$return = _elm_lang$core$Native_Platform.outgoingPort(
	'return',
	function (v) {
...
var _user$project$FindViewFunctionsApp$init = function (_p0) {
	var _p1 = _p0;
	var viewFunctions = _elm_lang$core$Dict$keys(
		function (_) {
			return _.viewFunctions;
		}(
			_user$project$SubjectModuleInfo$getModuleInfo(_p1.sourceCode)));
	return A2(
		_elm_lang$core$Platform_Cmd_ops['!'],
		{ctor: '_Tuple0'},
		{
			ctor: '::',
			_0: _user$project$FindViewFunctionsApp$return(viewFunctions),
			_1: {ctor: '[]'}
		});
};
var _user$project$FindViewFunctionsApp$main = _elm_lang$core$Platform$programWithFlags(
	{
		init: _user$project$FindViewFunctionsApp$init,
		update: F2(
			function (_p3, _p2) {
				var _p4 = _p3;
				var _p5 = _p2;
	...
	A2(
		...
		A2(_elm_lang$core$Json_Decode$field, 'sourceCode', _elm_lang$core$Json_Decode$string)));
var _user$project$FindViewFunctionsApp$Flags = function (a) {
	return {sourceCode: a};
};

var Elm = {};
Elm['FindViewFunctionsApp'] = Elm['FindViewFunctionsApp'] || {};
if (typeof _user$project$FindViewFunctionsApp$main !== 'undefined') {
    _user$project$FindViewFunctionsApp$main(Elm['FindViewFunctionsApp'], 'FindViewFunctionsApp', undefined);
}
